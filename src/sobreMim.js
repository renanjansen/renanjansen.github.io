...
function Sobremim (){
  ...
  <div class="conteiner-fluid text-center bg-light pt-5 mb-0">
   ...
   <p class="fs-1">Busco uma primeira oportunidade no mercado e acredito que poderei otimizar minhas capacidades e desenvolver outras habilidades latentes.</p>
  </div>
