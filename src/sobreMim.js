...
function Sobremim (){
  ...
  <div class="conteiner-fluid text-center bg-light pt-5 mb-0">
   ...
   <p class="fs-1">Técnico em mecatrônica, estudante de análise e desenvolvimento de sistemas, descobri na pandemia de 2020/2021 um mundo totalmente novo e repleto de oportunidades.</p>
   <p class="fs-1">Tenho dedicado horas de meus dias em estudos e práticas, tendo afiniade e interesse tanto em back quanto front-end.</p>
